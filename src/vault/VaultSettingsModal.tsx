...
/**
 * Vault management overlay: switch between known vaults, add new ones via
 * the native folder picker, and remove them — "forget" keeps the files,
 * "delete files" needs a second explicit click before touching the disk.
 */
