...
- **"Today" list** on home shows the subjects + tasks of the plans referenced by today's schedule blocks (weekly routine → study plan → subjects + tasks), grouped under their subject with done tasks checked; the blocks themselves appear only under "today's events".
